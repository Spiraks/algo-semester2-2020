/****************************************************************************
"Касание смерти" или удар пяти баллов
...
Ввод: v:количество целей Беатрикс(макс. 1000), n:количество связей между целями(макс. 3000), n пар связей. 
Вывод: YES, если Киддо может изобразить схему, которая ей понравится, NO - если не сможет. 
